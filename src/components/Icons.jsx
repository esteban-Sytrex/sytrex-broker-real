const iconClass = 'landing__audience-icon-svg'
...
const modalIconClass = 'demo-modal__icon-svg'

export function IconPerson() {
  return (
    <svg className={modalIconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
